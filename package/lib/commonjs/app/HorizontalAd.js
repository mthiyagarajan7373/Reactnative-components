  ...
  (0, _react.useEffect)(() => {
    const contentDelivery = async () => {
      try {
        ...
        if (result.status) {
          setAds(() => result.data.videoAdHorizontalVideo);
          const item = result.data.videoAdHorizontalVideo[0];
          if (item) {
  ...
  const renderItem = ({
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.TouchableWithoutFeedback, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
        ...
        }) : null, item.contentUrl ? (0, _Utils.isVideo)(item.contentUrl) || item.contentType === 'video' ?
        /*#__PURE__*/
        // <TouchableWithoutFeedback onPress={() => {}}>
        (0, _jsxRuntime.jsx)(_expoAv.Video, {
          source: {
            uri: item.contentUrl
          },
          style: styles.video,
...
exports.HorizontalAd = HorizontalAd;
//# sourceMappingURL=HorizontalAd.js.map